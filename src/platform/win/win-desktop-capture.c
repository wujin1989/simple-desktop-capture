...
static bool d3d11_create_device(d3d11_device_t* p_d3d11_device);
static bool dxgi_create_duplicator(d3d11_device_t* p_d3d11_device, dxgi_dup_t* p_dxgi_dup);
static int  dxgi_capture_frame(dxgi_dup_t* p_dxgi_dup, desktop_frame_t* p_dxgi_frame);
...
int dxgi_capture_frame(dxgi_dup_t* p_dxgi_dup, desktop_frame_t* p_dxgi_frame) {
...
void desktop_capture(desktop_frame_t* frame) {
