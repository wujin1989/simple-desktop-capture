#include "simple-desktop-capture-types.h"
#include "platform/platform-desktop-capture.h"

void simple_desktop_capture(simple_desktop_capture_frame_t* frame, simple_desktop_capture_type_t type) {
	platform_desktop_capture(frame, type);
}
